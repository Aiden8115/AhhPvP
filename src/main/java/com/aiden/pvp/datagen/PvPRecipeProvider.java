...
public class PvPRecipeProvider extends FabricRecipeProvider {
    ...
    @Override
    protected @NotNull RecipeGenerator getRecipeGenerator(RegistryWrapper.@NotNull WrapperLookup wrapperLookup,
            @NotNull RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void offerBBUUpgradeRecipe(Item input, Item result) {
                SmithingTransformRecipeJsonBuilder.create(
                        ...
                        result)
                        .criterion("has_bbu_upgrade_template",
                                this.conditionsFromItem(ModItems.BBU_UPGRADE_SMITHING_TEMPLATE))
